...
describe('HomeSidebar', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(useLocation).mockReturnValue({ pathname: '/home', search: '', hash: '', state: null, key: 'default', unstable_mask: '' } as any);
    });
    ...
    it('returns null when on home route (/)', () => {
        vi.mocked(useAuth).mockReturnValue({ isAuthenticated: true, user: {} as any, login: vi.fn(), logout: vi.fn() } as any);
        vi.mocked(useLocation).mockReturnValue({ pathname: '/', search: '', hash: '', state: null, key: 'default', unstable_mask: '' } as any);
